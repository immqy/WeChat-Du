package com.allenjuns.wechat.zxing.camera;
...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = PhoneUtils.dpToPx(
			  250);
	private static final int MIN_FRAME_HEIGHT = PhoneUtils.dpToPx(250);
	private static final int MAX_FRAME_WIDTH = PhoneUtils.dpToPx(250);
	private static final int MAX_FRAME_HEIGHT =PhoneUtils.dpToPx(250);
